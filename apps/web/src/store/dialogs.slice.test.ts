...
import { dialogClosed, dialogOpened, dialogsReducer, selectActiveDialog, selectIsDialogOpen } from './dialogs.slice.js';
...
describe('dialogs slice', () => {
  ...
  it('dialogClosed clears the active dialog', () => {
    const opened = dialogsReducer(undefined, dialogOpened({ kind: 'csvImportConfirm' }));
